                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <?= form_open('admin/dashboard/updateProfile', array('id' => 'updateProfileFormModal')); ?>
...
<script>
    $(document).ready(function () {
        $('#submitModalBtn').on('click', function () {
            var formData = $('#updateProfileFormModal').serialize();
            $.ajax({
                type: 'POST',
                url: $('#updateProfileFormModal').attr('action'),
                data: formData,
                dataType: 'json',
